...
FROM Event,Category,Place,Street,City,Event_Time,(SELECT Month(EventTime1.start_time) AS month1,City.id AS cityID EventGuests1.attending_count as maxAtt
																		FROM Event as Event1,Place AS Place1, Street AS Street1, City As City1, Event_Time AS EventTime1, Event_Guests AS EventGuests1
																		WHERE Event.id=EventTime1.event_id and Event.id=EventGuests1.event_id 
																					and Event.place_id=Place.id and Place.street_id = Street.id and Street.city_id = City.it
